...
export default function InsurerAnalyticsComingSoon() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#f9fafb]">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[#6b7280] mb-8 leading-relaxed">
          The <strong>Advanced Analytics Suite</strong> is processing live claim data to generate your first reports. 
          Expect detailed loss ratio and performance metrics soon.
        </p>
