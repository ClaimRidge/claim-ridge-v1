...
export default function InsurerFraudComingSoon() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#f9fafb]">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[#6b7280] mb-8 leading-relaxed">
          The <strong>AI Fraud Detection Engine</strong> is currently training on historical patterns to protect your organization. 
          Real-time flagging will be available soon.
        </p>
