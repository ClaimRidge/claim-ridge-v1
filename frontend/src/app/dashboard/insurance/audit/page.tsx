...
export default function InsurerAuditComingSoon() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#f9fafb]">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[#6b7280] mb-8 leading-relaxed">
          The <strong>Compliance & Audit Logging</strong> system is being secured with immutable event records. 
          Expect full transparency into every adjudication decision soon.
        </p>
