...
export default function InsurerPaymentsComingSoon() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#f9fafb]">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[#6b7280] mb-8 leading-relaxed">
          The <strong>Payment Reconciliation Hub</strong> is being integrated with local banking APIs. 
          Automated provider payouts will be available soon.
        </p>
